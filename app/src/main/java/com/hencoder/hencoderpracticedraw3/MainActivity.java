...
public class MainActivity extends AppCompatActivity {
...

  {
    ...
    pageModels.add(
        new PageModel(R.layout.sample_draw_text_on_path, R.string.title_draw_text_on_path,
            R.layout.practice_draw_text_on_path));
    pageModels.add(
        new PageModel(R.layout.sample_draw_text_run, R.string.title_draw_text_run,
            R.layout.sample_draw_text_run));
    ...
    pageModels.add(
        new PageModel(R.layout.sample_set_fake_bold_text, R.string.title_set_fake_bold_text,
            R.layout.practice_set_fake_bold_text));
    pageModels.add(
        new PageModel(R.layout.sample_set_strike_thru_text, R.string.title_set_strike_thru_text,
            R.layout.practice_set_strike_thru_text));
    pageModels.add(
        new PageModel(R.layout.sample_set_underline_text, R.string.title_set_underline_text,
    ...
    pageModels.add(new PageModel(R.layout.sample_set_text_locale, R.string.title_set_text_locale,
        R.layout.sample_set_text_locale));
    pageModels.add(
        new PageModel(R.layout.sample_get_letter_spacing, R.string.title_get_letter_spacing,
            R.layout.sample_get_letter_spacing));
    ...
    pageModels.add(new PageModel(R.layout.sample_get_text_widths, R.string.title_get_text_widths,
        R.layout.sample_get_text_widths));
    pageModels.add(new PageModel(R.layout.sample_get_run_advance, R.string.title_get_run_advance,
        R.layout.sample_get_run_advance));
    pageModels.add(
        new PageModel(R.layout.sample_get_offset_for_advance, R.string.title_get_offset_for_advance,
            R.layout.sample_get_offset_for_advance));
    pageModels.add(
        new PageModel(R.layout.sample_draw_circle_center_text, R.string.title_circle_center_text,
            R.layout.practice_draw_circle_center_text));
    pageModels.add(
        new PageModel(R.layout.sample_img_and_text, R.string.title_text_and_img,
            R.layout.sample_img_and_text));
  }
